          ...
          productDetailsController.selectedIndex3.value == -1 &&
            ...
            children: [
              productDetailsController
                  ...
                  ? CustomText(
                text:
                '${productDetailsController.childrenVariationModel3.value
                    .data?[0].productAttributeName
                    .toString()
                    .tr ?? ''}:',
                size: 14.sp,
          ...
          productDetailsController.selectedIndex4.value == -1 &&
            ...
            children: [
              productDetailsController
                  ...
                  ? CustomText(
                text:
                '${productDetailsController.childrenVariationModel4.value
                    .data?[0].productAttributeName
                    .toString()
                    .tr ?? ''}:',
                size: 14.sp,
          ...
          productDetailsController.selectedIndex5.value == -1 &&
            ...
            children: [
              productDetailsController
                  ...
                  ? CustomText(
                text:
                '${productDetailsController.childrenVariationModel5.value
                    .data?[0].productAttributeName
                    .toString()
                    .tr ?? ''}:',
                size: 15.sp,
          ...
          productDetailsController.selectedIndex6.value == -1 &&
            ...
            children: [
              productDetailsController
                  ...
                  ? CustomText(
                text:
                '${productDetailsController.childrenVariationModel6.value
                    .data?[0].productAttributeName
                    .toString()
                    .tr ?? ''}:',
                size: 14.sp,
    ...
    return productDetailsController.initialVariationModel.value.data != null &&
      ...
      children: [
        productDetailsController.initialVariationModel.value.data !=
            ...
            ? CustomText(
          text:
          '${productDetailsController.initialVariationModel.value.data?[0]
    ...
    return productDetailsController.selectedIndex1.value == -1 &&
      ...
      children: [
        ...
        productDetailsController.childrenVariationModel1.value.data !=
            ...
            ? CustomText(
          text:
          '${productDetailsController.childrenVariationModel1.value.data?[0]
              .productAttributeName
              .toString()
              .tr}:',
          size: 14.sp,
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                                color: productDetailsController
                                    ...
                                    ?
                                AppColor
                                    .primaryColor : AppColor.cartColor,
                      ...
                      Obx(() {
                        return productDetailsController.selectedIndex2.value == index
                            ? Container(
                          width: 99.w,
                          height: 36.h,
                          decoration: BoxDecoration(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                  ...
                                  // Intial variation null
                                  productDetailsController.initialVariationModel
                                      .value.data == null ||
                                      productDetailsController
                                          .initialVariationModel
                                          .value
                                  ...
                                  SvgPicture.asset(
                                      ...
                                      productDetailsController.variationsStock
                                          .value == 0
                                      ? SvgPicture.asset(
                                      SvgIcon.increment, color: Colors.grey,
                                      height: 20.h,
                                      width: 20.w)
                                      : SvgPicture.asset(SvgIcon.increment,
    ...
    return productDetailsController.selectedIndex2.value == -1 &&
      ...
      children: [
        productDetailsController
            ...
            ? CustomText(
          text:
          '${productDetailsController.childrenVariationModel2.value.data?[0]
              .productAttributeName
              .toString()
              .tr ?? ''}:',
          size: 14.sp,
